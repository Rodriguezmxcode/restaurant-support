...
import {ActivityIndicator, Image, KeyboardAvoidingView, Platform, Pressable, RefreshControl, SafeAreaView, ScrollView, StatusBar, StyleSheet, Text, TextInput, View} from 'react-native';
...
const restaurantScene = require('./assets/restaurant-bar.jpg');
    ...
    <KeyboardAvoidingView style={{flex: 1}} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{flexGrow: 1}}>
        <View style={styles.loginHero}>
          ...
          <Image source={restaurantScene} style={styles.welcomeScene} resizeMode="cover" accessibilityLabel="Escena ilustrativa de un restaurante moderno con bar"/>
...
const styles=StyleSheet.create({
  welcomeScene:{width:"100%",height:164,borderRadius:18,marginTop:22},dashboardScene:{width:"100%",height:100,borderRadius:14,marginBottom:18},
