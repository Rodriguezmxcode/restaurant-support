...
export default function WeeklyBonusPanel({allowedLocations}:{allowedLocations?:string[]}){
 ...
 return <section className="panel" style={{marginBottom:16}}>
  ...
  <div style={{padding:18,display:'grid',gap:14}}>
   ...
   <div className="detail-block"><label>ELIGIBILITY GUARDRAILS</label><p>Leadership/Logbook contributes points to the weekly score but does not block qualification. OpsVista will show the exact operating gate whenever a location fails eligibility; it will not silently remove a restaurant from the ranking.</p></div>
  </div>
 </section>;
}
