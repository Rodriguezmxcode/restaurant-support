...
export default function LocationDashboard({allowedLocations,allLocations,onOpenTasks,onOpenLabor}:Props){
  ...
  return <div className="location-dashboard">
    ...
    {!loading&&!error&&!cards.length&&<section className="location-dashboard-empty">No se recibieron locaciones para este periodo y alcance. OpsVista no sustituirá información de prueba.</section>}
