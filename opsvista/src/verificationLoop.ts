...
export const demoVerificationMeasurements: VerificationMeasurement[] = [
  {
    actionKey: 'orange::labor_above_target',
    measuredAt: '2026-08-18T17:15:00-06:00',
    beforeValue: 24.8,
    afterValue: 21.0,
    targetValue: 21.0,
    unit: '%',
    source: 'Labor Intelligence · representative follow-up',
  },
  {
    actionKey: 'danbury::overtime_exposure',
    measuredAt: '2026-08-18T17:20:00-06:00',
    beforeValue: 11.5,
    afterValue: 7.0,
    targetValue: 0,
    unit: ' hrs',
  ...
  {
    actionKey: 'orange::ramp_evidence_overdue',
    measuredAt: '2026-08-18T17:25:00-06:00',
    evidenceResolved: true,
    source: 'Ramp Compliance · representative follow-up',
  },
  {
    actionKey: 'stamford::evidence_rejected_unresolved',
    measuredAt: '2026-08-18T17:30:00-06:00',
    evidenceResolved: false,
    source: 'Evidence Audit · representative follow-up',
  },
];

export function measurementFor(actionKey?: string) {
  if (!actionKey) return undefined;
  return demoVerificationMeasurements.find(item => item.actionKey === actionKey);
}
