...
export type OpsVistaModule =
  ...
  | 'Team' | 'Horarios' | 'Tasks' | 'Bono semanal' | 'Action Center' | 'Proyectos' | 'Prioridades' | 'Pagos' | 'Transferencias' | 'Configuración';
...
const allModules: OpsVistaModule[] = ['Resumen','Locaciones','Ventas','Google Reviews','Local Intelligence','Finanzas','Gastos','Team','Horarios','Tasks','Bono semanal','Action Center','Proyectos','Prioridades','Pagos','Transferencias','Configuración'];
...
export const rolePermissions: Record<OpsVistaRole, PermissionSet> = {
  ...
  'Location Manager': {
    modules: ['Resumen','Locaciones','Ventas','Google Reviews','Local Intelligence','Team','Horarios','Tasks','Bono semanal','Action Center','Proyectos','Prioridades','Pagos','Transferencias'],
