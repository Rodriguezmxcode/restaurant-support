...
const icon:Record<string,string>={Resumen:'⌂',Locaciones:'▦',Ventas:'↗','Google Reviews':'✦','Local Intelligence':'⌁',Gastos:'$',Horarios:'◷',Tasks:'☑','Bono semanal':'★','Action Center':'⚡',Proyectos:'◆',Pagos:'$',Transferencias:'⇄',Restaurant365:'R',Integraciones:'⛓',Configuración:'⚙'};
...
const searchCatalog:SearchEntry[]=[
  ...
  {section:'Pagos',label:'Pagos',description:'Solicitudes, autorizaciones y registro de pagos',keywords:['payments','payment','pago','pagos','requests','solicitudes','aprobaciones','cheques','finanzas','finance','financial']},
