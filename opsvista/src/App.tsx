...
const icon:Record<string,string>={Resumen:'⌂',Locaciones:'▦',Ventas:'↗','Google Reviews':'✦','Local Intelligence':'⌁',Gastos:'$',Horarios:'◷',Tasks:'☑','Bono semanal':'★','Action Center':'⚡',Proyectos:'◆',Pagos:'$',Finanzas:'▥',Transferencias:'⇄',Restaurant365:'R',Integraciones:'⛓',Configuración:'⚙'};
