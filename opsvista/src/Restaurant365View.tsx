...
type Tab='Resumen'|'P&L'|'Facturas y AP'|'Vendors'|'Cuentas GL'|'Conexión';
type Status={
...
const tabs:Tab[]=['Resumen','P&L','Facturas y AP','Vendors','Cuentas GL','Conexión'];
  ...
  return <div style={{display:'grid',gap:16}}>
    ...
    {tab==='Conexión'?<Restaurant365IntegrationPanel canManage={canManageIntegrations}/>:tab==='Resumen'?<>
      ...
      <div className="metrics-grid">
        ...
        <div className="metric-card"><div className="metric-label">LOCACIONES</div><div className="metric-value">{status?.mappedLocationCount??'—'}<span style={{fontSize:16,color:'#64748b'}}> / 6</span></div><div className="metric-note">Restaurantes identificados</div></div>
      ...
      <section className="panel">
        ...
        <div className="roadmap-grid">
          <div><span>01</span><strong>P&L por locación</strong><p>Ingresos, COGS, labor, gastos operativos, EBITDA y comparación contra periodos anteriores.</p></div>
          ...
          <div><span>03</span><strong>Vendors y cuentas GL</strong><p>Catálogo de proveedores, codificación contable y movimientos que explican cada total.</p></div>
