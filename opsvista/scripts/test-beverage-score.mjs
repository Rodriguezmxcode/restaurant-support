...
try {
  ...
  for(const name of ['shared/beverageMetrics','shared/beverageScore','shared/tenantAccess','shared/bonusWeek','server/bonusWeek','server/integrationStore','server/sourceCache','server/authorization','server/beverageScore','src/bonusEngine','server/beverageScore.test']){
