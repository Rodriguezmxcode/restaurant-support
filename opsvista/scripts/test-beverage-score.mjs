...
try {
  ...
  for(const name of ['shared/beverageMetrics','shared/beverageScore','shared/tenantAccess','server/sourceCache','server/authorization','server/beverageScore','src/bonusEngine','server/beverageScore.test']){
